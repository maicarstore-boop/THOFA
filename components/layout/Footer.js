        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-300">
              <li className="flex items-start gap-2"><i className="fas fa-phone mt-1"></i><span>+250784109571</span></li>
              <li className="flex items-start gap-2"><i className="fas fa-envelope mt-1"></i><span>tumurihafingo@gmail.com</span></li>
