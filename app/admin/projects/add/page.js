...
export default function AddProject() {
  ...
  const [formData, setFormData] = useState({
    ...
    paypal_email: '' // PayPal email field
  });
      ...
      <header className="bg-[#1a3a1a] text-white shadow-lg">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center flex-wrap gap-4">
          <div>
            ...
            <p className="text-sm text-gray-300">Create a new charity project with images and details</p>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {activeTab === 'account' && (
              <div className="space-y-6">
                <p className="text-sm text-gray-500 mb-4">
                  This information will be displayed on the project page for donors who want to send money directly.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-400 mt-1">
                      Donors can send money via PayPal to this email address
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex gap-4 flex-wrap pt-4 border-t border-gray-200">
              ...
              >
                {loading || uploading ? (
                  <><i className="fas fa-spinner fa-spin"></i> {uploading ? 'Uploading Images...' : 'Creating Project...'}</>
                ) : (
